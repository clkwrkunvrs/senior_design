...
class vnaStuff():
    ...
    def plotPosition(self, currentTheta=0, currentR=0):
        ...
        rotation = 90
        half_beam = 5
        theta = [0, math.radians(currentTheta + rotation + offset)]
        thetaLeft = [0, math.radians(currentTheta-half_beam + rotation + offset)]
        thetaRight = [0, math.radians(currentTheta+half_beam + rotation + offset)]
        r = [0, currentR]
